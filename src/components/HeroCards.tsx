...
export const HeroCards = () => {
  return (
    <div className="hidden lg:flex flex-row flex-wrap gap-8 relative w-[700px] h-[500px]">
      {/* Testimonial */}
      <div className="absolute w-[360px] left-6 -top-[60px]">
        <img src={StationOne} className="w-[480px]" />
      </div>

      <div className="absolute w-[280px] left-[100px] -bottom-0">
        <img src={StationTwo} className="w-[480px]" />
      </div>
      ...
      {/* <Card className="absolute w-[340px] -top-[15px] drop-shadow-xl shadow-black/10 dark:shadow-white/10">
        ...
        <CardContent>Add image here</CardContent>
      </Card> */}
